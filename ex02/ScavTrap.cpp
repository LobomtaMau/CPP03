...
/*   Updated: 2024/05/21 14:48:20 by mbaptist         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(const ScavTrap &other) : ClapTrap(other) {
    std::cout << "ScavTrap copy Constructor " << _name << " called\n";
}
...
void ScavTrap::attack(const std::string &target) {
    if(this->_energyPoints > 0 && this->_hitPoints > 0) {
        ...
        std::cout << "ScavTrap " << _name << " can't attack, no energy or hit points left.\n";
}
